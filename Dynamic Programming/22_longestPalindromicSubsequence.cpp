...
int main(){
    ...
    cout << "LCS via memoization: " << memoize(n-1, m-1, s, r, dp) << endl;
    cout << "LCS via tabulation: " << tabulate(s, r) << endl;
    cout << "LCS via space optimization: " << spaceOptimal(s, r) << endl;
    cout << "LCS via space optimization single array: " << spaceOptimalSingleArray(s, r) << endl;
    return 0;
}